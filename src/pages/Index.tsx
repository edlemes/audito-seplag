  ...
  <div className="flex min-h-screen flex-col">
    ...
    <section className="seplag-gradient py-12">
      <div className="container mx-auto flex flex-col items-center gap-4 px-4 text-center">
        ...
        <Link
          to="/agendamento"
          className="inline-flex items-center gap-2 rounded-lg bg-secondary px-6 py-3 font-semibold text-secondary-foreground shadow-lg transition hover:bg-secondary/90"
        >
