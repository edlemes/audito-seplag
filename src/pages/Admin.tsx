...
import { CalendarDays, Users, ClipboardCheck, MessageSquare, LogOut, ShieldCheck, FileSearch, LayoutDashboard, Download, Search } from "lucide-react";
...
const Admin = () => {
  ...
  const loadData = async () => {
    ...
    setPieData(Object.entries(secMap).map(([name, value]) => ({ name: name.split(" / ")[0] || name, value })));
